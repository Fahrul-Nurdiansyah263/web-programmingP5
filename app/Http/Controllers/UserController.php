...
class UserController extends Controller
{
    ...
    public function cetakUser(Request $request)
    {
        ...
        $request->validate([
            ...
            'tanggal_awal.required' => 'Tanggal Awal Harus diiisi.',
            'tanggal_akhir.required' => 'Tanggal Akhir Harus diiisi.',
            'tanggal_akhir.after_or_equal' => 'Tanggal Akhir harus lebih besar atau sama dengan.',
        ]);
